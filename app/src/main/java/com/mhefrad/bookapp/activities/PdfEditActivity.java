...
import com.mhefrad.bookapp.databinding.ActivityPdfEditBinding;
...
public class PdfEditActivity extends AppCompatActivity {
    ...
    //book id get from intent started from AdapterPdfActivity
    ...
    private void uploadPdf() {
        Log.d(TAG, "uploadPdf: Starting updating pdf into db...");
    ...
    private void loadCategories() {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Log.d(TAG, "onCancelled: Failed to load Category due to "+error.getMessage());
                Toast.makeText(PdfEditActivity.this, "Failed to load Category due to "+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
