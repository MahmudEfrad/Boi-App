...
import com.mhefrad.bookapp.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void updateUserInfo() {
        ...
        hashMap.put("userType","user"); //possible values are user, will make admin manually in firebase realtime by changing this value
        ...
        ref.child(uId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        //since user account created so start dashboard of user
