...
import com.mhefrad.bookapp.adapter.AdapterComment;
import com.mhefrad.bookapp.adapter.AdapterPdfFavorite;
import com.mhefrad.bookapp.databinding.ActivityPdfDetailBinding;
import com.mhefrad.bookapp.databinding.DialogCommentAddBinding;
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot ds: snapshot.getChildren()){
                            //get data as model, spelling of variable in model must be same as in firebase
    ...
    private void checkIsFavorite(){
        ...
        reference.child(firebaseAuth.getUid()).child("Favorites").child(bookId)
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        isInMyFavorite = snapshot.exists(); //true, false if not exits
                        if (isInMyFavorite){
                            //exits in favorites
                            binding.favoriteBtn.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.drawable.ic_favorite_white,0,0);
                            binding.favoriteBtn.setText("Remove Favorite");
                        }else {
                            //not exits in favorites
