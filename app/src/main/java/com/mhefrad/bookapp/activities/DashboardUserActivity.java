...
import com.mhefrad.bookapp.BooksUserFragment;
import com.mhefrad.bookapp.databinding.ActivityDashboardUserBinding;
...
public class DashboardUserActivity extends AppCompatActivity {
    ...
    private static final String TAG = "USER_DASHBOARD_TAG";
    ...
    private void setupViewPagerAdapter(ViewPager viewPager){
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                /*Load Categories - Static e.g. All, Most viewed, Most Downloads*/
                //add data to models
