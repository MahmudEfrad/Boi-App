...
import com.mhefrad.bookapp.activities.PdfEditActivity;
import com.mhefrad.bookapp.databinding.RowPdfAdminBinding;
import com.mhefrad.bookapp.filters.FilterPdfAdmin;
        ...
        builder.setTitle("Choose Options")
                .setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0){
                            //edit clicked, Open PdfEditActivity to edit the info
